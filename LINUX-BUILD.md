...
> **Linux is SHIPPED.** notzero **0.1.23** is live (download + auto-update) at https://dl.getnotzero.com —
> all three platforms (mac, Windows, Linux) now ship 0.1.23 from a unified `main`.
...
Lottery). **All three platforms — macOS, Windows, Linux — are shipped at 0.1.23** (https://dl.getnotzero.com).
